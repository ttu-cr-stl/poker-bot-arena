...
function formatBoardCards(cards?: string[] | null, fallback?: string[] | string): string | undefined {
...
export function describeEvent(event: SpectatorEvent, seats: SpectatorSeatState[], board?: string[]): string {
  if (!event) {
    return "";
  }
